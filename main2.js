...
project1.textContent = 'Arva ära';
project2.textContent = 'Täringumäng';
project3.textContent = 'Panga äpp';
project4.textContent = 'Panga veebileht';
project5.textContent = 'Kaardi äpp';
